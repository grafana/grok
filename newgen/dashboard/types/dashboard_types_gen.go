...
Id disjunction<int64 | null> `json:"id,omitempty"`
...
Mappings []disjunction<ValueMap | RangeMap | RegexMap | SpecialValueMap> `json:"mappings,omitempty"`
...
Value disjunction<float64 | null> `json:"value"`
